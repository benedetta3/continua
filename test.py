...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--silent', action='store_true', help='modalitÃ  silenziosa')
    ...
    if args.t == '32':
        quantpivot = gruppo6.quantpivot32.QuantPivot()
    elif args.t == '64':
        quantpivot = gruppo6.quantpivot64.QuantPivot()
    elif args.t == '64omp':
        quantpivot = gruppo6.quantpivot64omp.QuantPivot()
    # =========================
    start = time.time()
